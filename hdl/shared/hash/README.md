...
## edge case
Case 1: 
- pk hash input (SHA3-256 of 1184-byte public key)
- ct hash input (SHA3-256 of 1088-byte public key)
...
Rate = 168 bytes, input = 34 bytes (1 block), output = 672 bytes → 4 squeeze rounds
...
→ PERMUTE
→ SQUEEZE block 3 (168 bytes out)
→ PERMUTE
→ SQUEEZE block 4 (168 bytes out)
→ DONE
